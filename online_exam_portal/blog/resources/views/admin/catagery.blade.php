        ...
        <a data-editcatdata="{{$datas->name}}" data-editcatid="{{$datas->id}}" type="button" class="btn" data-toggle="modal" data-target="#editcat" style="border: none;background:none;color: green;"><i  class="fas fa-edit" aria-hidden="true" data-toggle="tooltip" data-placement="right" title="Edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

        <a  data-deletename="{{$datas->name}}" data-deleteid="{{$datas->id}}" class="btn"  data-toggle="modal" data-target="#deletemodal" style="border: none;background:none;color:red;"><i  class="far fa-trash-alt" aria-hidden="true" data-toggle="tooltip" data-placement="left" title="Delete"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        @csrf
                <div class="form-group">
                <label>Category Name</label>      
                <input type="text" name="name" class="form-control" id="reset"> 
                </div>
              </div>
              <div class="modal-footer">
